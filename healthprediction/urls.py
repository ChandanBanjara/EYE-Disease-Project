...
from healthprediction.views import Symtoms_to_Disease, ChatGPTDiseaseQuery,EyeDiseasePrediction,HeartDiseasePredictionFunction,DiabetesDiseasePredictionFunction
urlpatterns = [
    ...
    # path('chatgpt/', ChatGPTDiseaseQuery.as_view(),name='chatgpt'),
]
